...
export default function DashboardPage() {
  ...
  useEffect(() => {
    try {
      // Safe LocalStorage reading for Pickups
      const savedPickups = localStorage.getItem('userPickups');
      const savedCount = localStorage.getItem('lifetimeUsage');
      ...
      if (savedCount) {
          ...
          setLifetimeUsage(isNaN(count) ? 0 : count);
      }
