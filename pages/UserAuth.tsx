      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 border border-slate-100 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">
              {isLogin ? 'Login to access your household portal.' : 'Join PharmaSafe to dispose responsibly.'}
            </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            {isLogin ? (
               <p className="text-sm text-slate-500">
                  New to PharmaSafe? <button onClick={() => setIsLogin(false)} className="text-teal-600 font-bold hover:underline ml-1">Register Now</button>
               </p>
            ) : (
               <p className="text-sm text-slate-500">
